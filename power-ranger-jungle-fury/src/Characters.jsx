...
function Characters(){
    return(
        ...
        <div className="slider" id="Characters">
      ...
      <div className="slide" id="slide4">
        ...
        <div className="skills-bar4">
          <div className="bar4">
            ...
            <div className="progress-line4"><span className="html4"></span></div>
            <div className="bar4">
              <div className="info4">
                <span className="M5">Martial Arts Mastery</span>
              </div>
              <div className="progress-line4"><span className="css4"></span></div>
              <div className="bar4">
                <div className="info4">
                  <span className="J5">Jungle Karma</span>
                </div>
                <div className="progress-line4"><span className="bootstrap4"></span></div>
                <div className="bar4">
                  <div className="info4">
                    <span className="M5">Morphing Ability</span>
                  </div>
                  <div className="progress-line4">
                    <span className="javascript4"></span>
                  </div>
                  <div className="bar4">
                    <div className="info4">
                      <span className="W88">Weapon Proficiency</span>
                    </div>
                    <div className="progress-line4"><span className="c4"></span></div>
                  </div>
                </div>
              </div>
            </div>

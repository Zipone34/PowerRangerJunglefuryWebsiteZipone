...
function Characters(){
    ...
    <div className="slides">
      ...
      <div class="skills1">
        <div classNa="skills-bar1">
          <div className="bar1">
            <div className="info1">
            <h1 className="Y">YELLOW RANGER<img src={claw} className="bite"/></h1>
              <span className="A1">Animal Spirit Powers</span>
            </div>
            <div className="progress-line1"><span class="html1"></span></div>
            <div className="bar1">
              <div className="info1">
                <span className="M1">Martial Arts Mastery</span>
              </div>
              <div className="progress-line1"><span class="css1"></span></div>
              <div className="bar1">
                <div className="info1">
                  <span className="">Jungle Karma</span>
                </div>

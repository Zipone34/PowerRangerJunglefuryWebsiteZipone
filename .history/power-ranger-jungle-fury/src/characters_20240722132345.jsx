        ...
        <div className="skills-bar">
          <div className="bar">
            ...
            <div className="bar">
              ...
              <div className="progress-line"><span class="css"></span></div>
              <div className="bar">
                <div className="info">
                  <span>BOOTSTRAP</span>
                </div>
                <div className="progress-line"><span class="bootstrap"></span></div>
                <div className="bar">
                  <div className="info">
                  ...
                  <div className="bar">
                    ...
                    <div className="progress-line"><span class="c"></span></div>
                  </div>
                </div>
              </div>
            </div>

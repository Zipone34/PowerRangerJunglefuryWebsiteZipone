...
function Navbar (){
    return(
        ...
        <nav className="navbar">
            <a href="#" className="claw1">Home <img src={claw} className=""/> </a>
            <a href="#" className="claw2">About <img src={claw} className=""/> </a>
            <a href="#" className="claw3">Characters <img src={claw}/> </a>
            <a href="#" className="claw4">Contact <img src={claw}/> </a>
        </nav>
    </header>
    );
}

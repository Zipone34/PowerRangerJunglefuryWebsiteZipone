...
function Navbar (){
    return(
        ...
        <nav className="navbar">
            <a href="#"className="hover">Home<img src={claw} className="claw1"/></a>
            ...
            <a href="#" className="hover3">Goals<img src={claw} className="claw4"/></a>
            <a href="#" className="hover4">Contact<img src={claw} className="claw4"/></a>
        </nav>
    </header>
    );
}
